// biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: Legacy PokerNow log recovery is a linear state machine.
// biome-ignore-all lint/performance/useTopLevelRegex: Dynamic expressions include the PokerNow player identity pattern.
import type { PokerNowPlayer, PokerNowSession } from "./parser";
...
export function parseLegacyPokerNowLog(
  text: string,
